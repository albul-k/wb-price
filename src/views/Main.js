...
export default function Main() {
    ...
    return (
        <Grid container rowSpacing={1.5} spacing={3}>
            ...
            <Grid item xs={4}>
                <Typography align="center">Выручка</Typography>
            </Grid>
            <Grid item xs={4}>
                <Typography align="center">Доставка</Typography>
            </Grid>
            <Grid item xs={4}>
                <Typography align="center">Прибыль</Typography>
            </Grid>
                    ...
                    <Grid item xs={12}>
                        <TextFieldCustom
                            ...
                            InputProps={{
                                ...
                                endAdornment: (
                                    <InputAdornment position="end">
                                        <Tooltip title="Выручка за вычетом скидок и комиссии WB">
                                            <HelpOutlineIcon
                                                sx={{
                                                    color: 'action.active',
                                                    marginRight: (theme) => theme.spacing(1),
            ...
            <Grid item xs={4}>
                <Grid container rowSpacing={1.5} spacing={3}>
                    <Grid item xs={12}>
                        <TextFieldCustomMoney label="Стоимость доставки" value={stateCalc.delivery} />
                    </Grid>
                    <Grid item xs={12}>
                        <TextFieldCustomMoney label="Выручка за вычетом доставки" value={stateCalc.earningsNoDelivery} />
                    </Grid>
                </Grid>
            </Grid>
            <Grid item xs={4}>
                    ...
                    <Grid item xs={12}>
                        <TextFieldCustom
                            ...
                            InputProps={{
                                ...
                                endAdornment: (
                                    <InputAdornment position="end">
                                        <Tooltip title="Выручка за минусом себестоимости">
                                            <HelpOutlineIcon
                                                sx={{
                                                    color: 'action.active',
                                                    marginRight: (theme) => theme.spacing(1),
